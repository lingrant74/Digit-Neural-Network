    ...
    public static void main(String[] args) throws Exception {
        ...
        if (modelFile.exists()) {
            ...
            try {
                ...
                modelFile = null; // Force training
            }
        }
        
        // Train model if it doesn't exist or failed to load
        if (neuralNetwork == null) {
            ...
            // Load training data (using a subset for faster training)
            System.out.println("Loading training data...");
            MnistLoader.DataPoint[] train = MnistLoader.load(trainImages, trainLabels, 6000);
            MnistLoader.DataPoint[] test = MnistLoader.load(testImages, testLabels, 1000);
            ...
            for (int e = 1; e <= epochs; e++) {
                ...
                System.out.printf("Epoch %d/%d - Test accuracy: %.2f%%%n", e, epochs, acc);
            }
